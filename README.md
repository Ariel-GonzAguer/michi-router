...
La versión estable es la 1.2.0.
Si tienes alguna de estas versiones instaladas (1.1.x), actualízala a la versión 1.2.0 ejecutando el siguiente comando:
```bash
...
O:
```bash
npm install @arielgonzaguer/michi-router@1.2.0
```
