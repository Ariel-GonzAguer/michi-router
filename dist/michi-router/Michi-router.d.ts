 ...
 */
export declare function RouterProvider({ routes, children, layout: Layout }: RouterProviderProps): import("react/jsx-runtime").JSX.Element;
/**
 * Componente Link para navegación declarativa.
 * Previene la recarga de página y utiliza el historial del navegador.
 */
export declare const Link: ({ to, children, className, ...rest }: LinkProps & React.AnchorHTMLAttributes<HTMLAnchorElement>) => import("react/jsx-runtime").JSX.Element;
/**
